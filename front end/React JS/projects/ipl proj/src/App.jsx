...
function App() {
  ...
  let filterData = data.matchDetails.filter((item) => item["matchDetailsMap"]);
  ...
  async function fetchMatchData() {
    ...
    const options = {
      method: "GET",
      headers: {
        "X-RapidAPI-Key": "4c5c4b8c8emsh9de05ad426daec7p1e621fjsn65f9ffe5f43c",
